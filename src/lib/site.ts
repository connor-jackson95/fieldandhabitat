export const siteConfig = {
  ...
  socialLinks: [
    { label: "Instagram", href: "https://instagram.com/fieldandhabitat" },
    { label: "TikTok", href: "https://tiktok.com/@fieldandhabitat" },
    { label: "YouTube", href: "https://youtube.com" },
    { label: "Facebook", href: "https://facebook.com" },
    { label: "X", href: "https://x.com" },
  ],
  contactEmail: "editorial@fieldandhabitat.com",
} as const;
