  ...
  },
  {
    ...
    body: [
      ...
      list([
        { text: "Fishing tackle" },
        { text: "Motorboat fuel" },
        { text: "Boating equipment" },
      ]),
      p("Together, these laws became the financial backbone of modern conservation in America."),
      p("Every time a hunter buys shells or an angler purchases tackle, part of that sale contributes to state conservation funding."),
      p("That money does not stay in Washington. It comes back to the states."),
      h("How the Money Comes Back to Indiana"),
      p("Federal conservation money is distributed back to states using formulas based largely on land area and license sales."),
      p("That creates an incentive for states to maintain strong participation in hunting and fishing while also protecting habitat and public access."),
      p("Indiana receives millions of dollars annually through these federal programs."),
      p("That money helps fund:"),
      list([
        { text: "Public hunting areas" },
        { text: "Fish hatcheries" },
        { text: "Boat ramps and fishing access" },
        { text: "Wildlife research" },
        { text: "Habitat restoration" },
        { text: "Law enforcement and management staff" },
      ]),
      p("Without these federal contributions, the state would have to rely much more heavily on general taxes or cut services."),
      h("Boating and Outdoor Recreation Funding"),
      p("Indiana also receives funding tied to boating registration fees and fuel taxes."),
      p("That money supports public lake access, ramps, marinas, safety programs, and some fisheries work."),
