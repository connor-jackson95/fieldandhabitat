...
export const articles: Article[] = [
  ...
  {
    slug: "invasive-carp-in-2026",
    title: "Invasive Carp in 2026 What’s Working What’s Changing and What’s at Stake",
    excerpt:
    ...
    author: authors[0],
    body: [
      p("In parts of the Midwest, invasive carp now make up more than 70 percent of the total fish biomass in some river systems. At that point, the ecosystem is no longer balanced, it is controlled."),
      p("Indiana is not immune to that reality. Carp are already established in major rivers like the Wabash, White, and Ohio, and the focus in 2026 has shifted from stopping their arrival to managing their impact and preventing further spread."),
      p("Behind the scenes, agencies are investing heavily in a coordinated effort that spans multiple states, federal programs, and hundreds of millions of dollars. The question now is not whether carp can be eliminated, but whether current strategies can actually hold the line.", ["actually hold"]),
      h("Where Things Stand in Indiana"),
      p("Indiana sits in the middle of the fight. Rivers like the Wabash, White, and Ohio already hold established populations of silver and bighead carp. These fish reproduce quickly, outcompete native species for plankton, and reshape aquatic ecosystems."),
      p("According to the U.S. Geological Survey and the U.S. Fish and Wildlife Service, invasive carp can consume up to forty percent of their body weight in plankton each day. That matters because plankton supports the entire food chain, from larval sportfish to mussels."),
      p("The goal in Indiana is not elimination. At this point, that is not realistic. The focus is containment, suppression, and preventing further spread, especially toward the Great Lakes."),
      h("Keeping Carp Out of the Great Lakes"),
      p("The most important battle is happening north of Indiana near Chicago. If carp establish in Lake Michigan, the ecological and economic damage could be severe.", ["happening", "establish"]),
      p("That is why the Brandon Road Interbasin Project has become a central focus. The project is designed as a layered defense using electric barriers, underwater sound, bubble curtains, and flushing systems to block fish movement."),
      p("The U.S. Army Corps of Engineers is leading the effort with support from surrounding states. Planning and early work have accelerated into 2026 with significant federal funding."),
      p("This project represents the biggest long-term investment in the entire strategy. If it works, it buys time. If it fails, pressure increases everywhere else.", ["long-term"]),
      h("What Is Changing in 2026"),
      p("While barriers get the attention, most progress is happening on the water.", ["the attention"]),
      h("Commercial harvest is expanding"),
      p("A major shift has been the use of commercial fishing to remove carp at scale. Contracted crews are harvesting large volumes, especially in the Illinois River system, removing millions of pounds annually."),
      p("Research supported by the Illinois Natural History Survey shows that sustained harvest can reduce carp biomass and slow growth in targeted areas. Indiana is tied into this system through connected waterways like the Wabash."),
      p("The challenge is consistency. Carp reproduce quickly, so pressure has to remain high.", ["reproduce", "has to"]),
      h("Removal is becoming more precise"),
      p("Biologists are no longer relying only on nets. Telemetry, environmental DNA, and movement studies are helping track carp with greater accuracy. The Great Lakes Fishery Commission has supported monitoring efforts focused on preventing spread toward the Great Lakes."),
      p("One approach involves tagging individual fish and using them to locate larger groups. With better data, crews can focus effort where it matters most."),
      h("Funding remains strong but under pressure"),
      p("Funding continues through programs like the Great Lakes Restoration Initiative along with state contributions. However, in 2026 there is more focus on results."),
      p("Decision makers are asking whether efforts are reducing populations and which methods provide the best return. That pressure is pushing agencies toward measurable outcomes."),
      h("What Is Working and What Is Not"),
      p("The results are mixed but clearer than before."),
      p("What is working includes high volume harvest that reduces numbers in specific rivers, barrier systems that slow movement, and data driven removal that improves efficiency."),
      p("What is not working includes the reality that eradication is not possible with current tools, reproduction remains high in established systems, and long-term funding is uncertain.", ["long-term"]),
      p("A synthesis from the American Fisheries Society concluded that no single method will solve the issue. Success depends on combining strategies and maintaining effort over time.", ["will"]),
      h("What It Means for Indiana Outdoorsmen"),
      p("For anglers and water users, carp are already part of the system. In some waters, they are dominant."),
      p("This affects sportfish recruitment, forage availability, and overall river health. At the same time, there is growing interest in developing markets for carp, including fish meal and human consumption. If demand increases, removal efforts become more sustainable.", ["meal"]),
      p("There may also be more opportunities for direct involvement through bowfishing and local initiatives."),
      h("The Reality Going Forward"),
      p("The invasive carp fight in 2026 is more strategic and better funded than it was a decade ago. It is also more realistic."),
      p("This is no longer about stopping a new problem. It is about managing one that already exists and preventing it from getting worse."),
      p("For Indiana, that means staying engaged in a multi-state effort that stretches from the Wabash River to the edge of Lake Michigan. For anyone who spends time on the water, it means this issue will remain part of the landscape for years to come.", ["multi-state"]),
    ],
  },
  {
    slug: "the-5-best-fly-rod-and-reel-combos-for-lakes-and-ponds",
    title: "The 5 Best Fly Rod and Reel Combos for Lakes and Ponds",
    excerpt:
      "How to choose the right setup for bass, bluegill, and everything in between.",
    category: "gear",
    tags: ["Fishing", "Gear", "Fly Fishing"],
    publishedAt: "2026-05-08T17:33:00Z",
    updatedAt: "2026-05-08T17:35:00Z",
    readingTime: 6,
    author: authors[0],
    body: [
      p("How to choose the right setup for bass, bluegill, and everything in between.", undefined, {
        italic: true,
        size: "small",
      }),
      ...
      p("Rod weight matters most. A 6 weight is the sweet spot for bass and versatility."),
  ...
  {
    slug: "follow-the-money-how-does-indiana-fund-conservation",
    title: "Follow the Money: How Does Indiana Fund Conservation?",
    excerpt:
      "Most people assume conservation is funded by regular tax dollars.",
    category: "conservation",
    tags: ["Conservation", "Hunting", "Fishing"],
    publishedAt: "2026-05-08T20:40:00Z",
    updatedAt: "2026-05-08T21:24:00Z",
    readingTime: 8,
    author: authors[0],
    body: [
      p("Most people assume conservation is funded by regular tax dollars."),
      p("It seems logical enough. Public land, wildlife management, fish stocking, state parks, habitat restoration, boat ramps, wetlands, forests, and conservation officers all feel like things that would simply be paid for through the government like roads or schools."),
      p("But in Indiana and across the country, conservation works very differently."),
      p("In Indiana alone, managing public lands, fisheries, wildlife areas, hatcheries, conservation officers, state parks, and habitat programs costs well over $100 million annually across the Indiana Department of Natural Resources."),
      p("A huge portion of conservation funding comes from hunters, anglers, shooters, and boaters. Every time someone buys a deer tag, a fishing license, a box of turkey loads, a rifle, a tree stand, or even fuel for their boat, part of that money may eventually flow back into conservation projects."),
      p("That system has quietly shaped American conservation for nearly a century."),
      p("In Indiana, it helps fund everything from public fishing lakes and wetlands to fish hatcheries, shooting ranges, public hunting areas, wildlife research, and invasive carp programs.", undefined, {
        segments: [
          {
            type: "text",
            text: "In Indiana, it helps fund everything from public fishing lakes and wetlands to fish hatcheries, shooting ranges, public hunting areas, wildlife research, and ",
          },
          {
            type: "link",
            label: "invasive carp programs",
            href: "https://www.fieldandhabitat.com/articles/invasive-carp-in-2026",
          },
          { type: "text", text: "." },
        ],
      }),
      p("The average person enjoying a state fishing area or hiking through a wildlife property may never realize that many of those places were partially funded by duck hunters buying ammunition or bass anglers purchasing tackle."),
      p("To understand how conservation really works in Indiana, you must follow the money."),
      h("The Indiana Department of Natural Resources"),
      p("The main agency responsible for conservation in Indiana is the Indiana Department of Natural Resources, commonly called the DNR."),
      p("The DNR oversees:"),
      list([
        { text: "Fish and Wildlife Management" },
        { text: "State Parks" },
        { text: "Forestry" },
        { text: "Reservoirs and Lakes" },
        { text: "Boating Access" },
        { text: "Nature Preserves" },
        { text: "Public Hunting Land" },
        { text: "Conservation Law Enforcement" },
        { text: "Fish Hatcheries" },
        { text: "Invasive Species Programs" },
      ]),
      p("That work costs hundreds of millions of dollars every year."),
      p("Many people assume most of that money comes from the state’s general tax fund. While some do, a surprisingly large amount comes from dedicated conservation funding streams tied directly to outdoor recreation."),
      p("Indiana’s conservation system is built more like a partnership between outdoor users and government than a traditional tax funded program."),
      h("Hunting and Fishing Licenses"),
      p("The most visible funding source is hunting and fishing licenses."),
      p("When someone buys:"),
      list([
        { text: "A Deer Tag" },
        { text: "Turkey Permit" },
        { text: "Fishing License" },
        { text: "Trapping License" },
        { text: "Waterfowl Stamp" },
      ]),
      p("that money goes directly into conservation related accounts managed by the state."),
      p("Hunters and anglers are not simply paying for permission to hunt or fish. In many ways, they are paying into the conservation system itself."),
      p("Indiana relies heavily on these license sales."),
      p("But license revenue alone is not enough to support the entire system."),
      p("The real engine behind American conservation comes from two federal laws that most people have never heard of."),
      h("The Laws That Built Modern Conservation"),
      p("In the early 1900s, wildlife populations across America were struggling. Habitat loss, overharvest, pollution, and weak protections had pushed many species into decline."),
      p("To solve the funding problem, Congress created two major conservation laws that still shape conservation today."),
      p("The first was the Pittman–Robertson Wildlife Restoration Act in 1937."),
      p("This law placed excise taxes on:"),
      list([
        { text: "Firearms" },
        { text: "Ammunition" },
        { text: "Archery equipment" },
      ]),
      p("The money would then be redistributed back to state wildlife agencies like the Indiana Department of Natural Resources to support conservation projects."),
      p("A few years later, Congress created the fishing equivalent through the Dingell–Johnson Act."),
      p("This program applied similar taxes to:"),
      list([
        { text: "Fishing Tackle" },
        { text: "Rods and Reels" },
        { text: "Trolling Motors" },
        { text: "Boating Fuel" },
        { text: "Marine Electronics" },
      ]),
      p("Together, these laws created the backbone of modern American conservation funding."),
      p("That means hunters and anglers contribute far more than just license revenue. Their participation helps drive additional federal conservation funding into Indiana."),
      h("Who Actually Pays for Conservation in Indiana?"),
      p("Conservation funding in Indiana comes from several different sources, but most fish and wildlife funding can be traced back to two major contributors:"),
      list([
        { text: "Federal Wildlife and Sport Fish Restoration Funding" },
        { text: "Hunting, Fishing, and Trapping License Sales" },
      ]),
      p("Wildlife and Sport Fish Restoration funding is the federal funding generated through the Pittman–Robertson Wildlife Restoration Act and the Dingell–Johnson Act, as explained earlier."),
      h("Approximate Indiana Fish and Wildlife Funding Breakdown"),
      list([
        { text: "Wildlife and Sport Fish Restoration Funding (Pittman Robertson & Dingell Johnson): ~47%" },
        { text: "Hunting, Fishing, and Trapping License Revenue: ~29%" },
        { text: "All Grants and Donations: ~11%" },
        { text: "Lake and River Enhancement Programs: ~7%" },
        { text: "Capital and Preventative Maintenance Funds: ~5%" },
      ]),
      p("This means roughly three quarters of Indiana’s fish and wildlife funding comes directly from:"),
      list([
        { text: "Outdoor Recreation Users" },
        { text: "Excise Taxes on Hunting and Fishing Equipment" },
        { text: "Hunting and Fishing License Sales" },
      ]),
      p("While millions of people benefit from public land, wetlands, wildlife areas, and healthy fisheries, much of the direct conservation funding still comes from hunters, anglers, shooters, and boaters participating in the outdoor economy."),
      h("Where Does the Money Actually Go?"),
      p("When people hear “conservation funding,” they often picture buying land or planting trees."),
      p("In reality, the money supports a massive range of operations."),
      p("In Indiana, conservation funding helps pay for:"),
      list([
        { text: "Biologists and Conservation Officers" },
        { text: "Fish Hatcheries" },
        { text: "Boat Ramps" },
        { text: "Wetlands Restoration" },
        { text: "Prescribed Burns" },
        { text: "Public Shooting Ranges" },
        { text: "Public Land Maintenance" },
        { text: "Invasive Species Control" },
        { text: "Water Quality Projects" },
        { text: "Wildlife Research" },
        { text: "Public Education Programs" },
      ]),
      p("Some projects are highly visible."),
      p("Others happen almost entirely behind the scenes."),
      p("For example, Indiana’s fish hatcheries raise millions of fish used for stocking lakes and reservoirs across the state."),
      p("Habitat crews restore wetlands that improve waterfowl habitat while also helping reduce flooding and improve water quality."),
      p("Biologists monitor deer populations and disease outbreaks."),
      p("Conservation officers patrol public lands and waterways."),
      p("All of that requires long-term funding."),
      h("Does the State of Indiana Contribute Tax Dollars?"),
      p("Yes, but generally not at the level many people assume."),
      p("Some conservation programs receive support from:"),
      list([
        { text: "State Appropriations" },
        { text: "Bond Funding" },
        { text: "Grants" },
        { text: "Federal Infrastructure Programs" },
      ]),
      p("State parks also generate revenue through:"),
      list([
        { text: "Entrance Fees" },
        { text: "Camping Fees" },
        { text: "Marina Fees" },
      ...
      p("But fish and wildlife management relies heavily on dedicated user generated funding rather than general tax revenue. That approach was designed to create more stable long-term conservation funding without relying on political budgets."),
      h("Why Hunters and Anglers Matter So Much"),
      p("One of the biggest misconceptions in modern conservation is that hunting and fishing are separate from conservation."),
      p("American conservation was largely built around hunters and anglers."),
      p("The funding model itself reflects that history."),
      p("Many species that are common today were once in serious decline."),
      p("Wild turkey populations collapsed across much of the country in the early 1900s due to unregulated harvest and habitat loss."),
      p("White tailed deer faced similar struggles. By the early 1900s, deer populations had fallen dramatically across many parts of the country, including Indiana, where unregulated market hunting and deforestation had severely reduced numbers."),
      p("Wetlands were disappearing rapidly as land was drained for agriculture and development."),
      p("Dedicated conservation funding helped restore many of those populations."),
      p("That does not mean hunters and anglers are the only people who care about conservation."),
      p("Far from it."),
      p("Birdwatchers, hikers, photographers, kayakers, and everyday outdoor users all benefit from healthy ecosystems and public land."),
      h("The Growing Debate Around Conservation Funding"),
      p("Hunting participation has gradually declined over the past several decades. According to the U.S. Fish and Wildlife Service, hunters made up roughly 7.7% of the U.S. population in 1960 compared to about 4.6% in 2020."),
      p("Fishing participation has generally remained stronger, but conservation costs continue rising."),
      p("Meanwhile, millions of Americans now enjoy outdoor recreation without directly contributing to the traditional conservation funding model."),
      p("Someone hiking public land every weekend may contribute very little directly toward fish and wildlife management compared to someone purchasing hunting licenses, ammunition, and fishing tackle."),
      p("That has sparked ongoing debate within the conservation world."),
      p("Some argue the current system remains one of the most successful conservation funding models ever created."),
      p("Others believe the funding base needs to expand."),
      p("Ideas often discussed include:"),
      list([
        { text: "Outdoor Recreation Taxes" },
        { text: "Backpacking or Hiking Permits" },
        { text: "Gear Taxes for Non-Hunting Recreation" },
        { text: "Expanded State Conservation Funding" },
        { text: "Public Private Partnerships" },
      ]),
      p("There is no simple answer."),
      p("But nearly everyone involved agrees on one thing: conservation requires money."),
      p("Habitat restoration, fisheries management, law enforcement, and public land access cannot happen for free."),
      h("Could Conservation Exist Without Hunting and Fishing?"),
      p("Technically, yes."),
      p("But it would likely look very different."),
      p("Without hunting and fishing related funding, states would lose major revenue sources tied directly to conservation.  Indiana alone would need to make up $25 million annually, according to Indiana Department of Natural Resources."),
      p("That funding would need to be replaced somehow."),
      p("Possible alternatives could include:"),
      list([
        { text: "Higher General Taxes" },
        { text: "Recreation Fees" },
        { text: "Expanded Federal Funding" },
        { text: "Private Donations" },
      ]),
      p("Some countries rely much more heavily on general tax revenue for conservation."),
      p("The American model developed differently."),
      p("Here, conservation became closely tied to outdoor recreation and wildlife use."),
      p("That connection helped create stable long-term funding for habitat and wildlife restoration."),
      p("Whether that model can continue unchanged into the future remains one of the biggest questions facing conservation today."),
      h("Following the Money"),
      p("Conservation in Indiana is far more interconnected than most people realize."),
      p("The next time someone buys a fishing rod, a deer tag, a box of shotgun shells, a trolling motor, or a hunting license, part of that money may eventually help restore wetlands, stock fish, maintain public access, fund wildlife research, support conservation officers, and improve habitat."),
      p("That funding system has shaped modern conservation for generations."),
      p("Hunters and anglers are not just users of the resource. In many ways, they have become some of its primary financial supporters."),
      p("And whether someone agrees with hunting or not, the reality is difficult to ignore."),
      p("The next time you walk a wildlife area or launch a boat in Indiana, there is a good chance a hunter or angler helped pay for it."),
    ],
  },
];
